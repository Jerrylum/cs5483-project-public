...
from util.tune.objective.create_AdaBoostClassifier import create_AdaBoostClassifier
...
def objective(trial):
    model = create_AdaBoostClassifier(trial)
    return cross_val_10_fold(model, X_train, y_train)


study = optuna.create_study(
    study_name="adaboost-without-llm",
